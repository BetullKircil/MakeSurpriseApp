...
const DeleteUserRelativeModal = ({ visible, onConfirm, onCancel, userRelativeId }) => (
  <Modal transparent={true} visible={visible} animationType="fade">
    <View style={styles.modalOverlay}>
      <View style={styles.modalContainer}>
        <Text style={styles.modalTitle}>Profili Sil</Text>
        <Text style={styles.modalMessage}>Hediye vermek istediğin profili silmek istediğinizden emin misiniz?</Text>
...
export default DeleteUserRelativeModal;
